    ...
    stages {
        ...
        stage('Test') {
            steps {
                ...
                sh 'ssh -o StrictHostKeyChecking=no -i /var/lib/jenkins/raz-key.pem ec2-user@${EC2_IP} "aws s3 cp s3://raz-flask-artifacts/alpaca.tar.gz /home/ec2-user/alpaca.tar.gz"'
            }
        }
    }
}
